...
class AdvancedPrismExtractor:
    ...
    def extract_prism_objects(self, output_dir, selected_slides=None):
        ...
        if selected_slides:
            ...
            embedded_objects = [obj for obj in embedded_objects if obj["slide"] in selected_slides_set]
...
The tool will extract PRISM objects from the specified slides, or all slides if none specified.
    ...
    parser.add_argument('--slide', '-s', type=int, action='append', dest='individual_slides',
